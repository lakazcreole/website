  ...
  <nav class="bg-grey-lightest text-lg">
    <div class="container mx-auto flex">
      ...
      <div class="flex ml-auto">
        <button class="block sm:hidden border border-black px-2 py-2 rounded my-auto mr-3">
          <div class="w-6 border-b-2 border-black mb-1"></div>
          <div class="w-6 border-b-2 border-black mb-1"></div>
          <div class="w-6 border-b-2 border-black"></div>
        </button>
