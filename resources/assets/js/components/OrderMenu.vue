                ...
                <div class="card mb-3">
                    ...
                    <div>
                        <ul class="list-group list-group-flush">
                            <li v-for="product in products" v-if="product.type === type.key" class="list-group-item bg-light">
                                ...
                                <div v-if="product.id === expandedProductId">
                                    ...
                                    <div class="input-group my-3">
                                        ...
                                        <select v-model="optionId" class="custom-select" :id="'select-side-' + product.id">
                                            ...
                                            <option v-for="side in products.filter(product => product.type === 'side')" :value="side.id">
                                                {{ side.name }}
                                            </option>
                                        </select>
                                    </div>
