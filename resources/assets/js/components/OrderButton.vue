<template>
  <div class="inline-flex">
    ...
    <button v-if="order" class="inline-flex sm:hidden rounded-lg border-2 border-orange px-4 py-2 items-center text-orange-light" @click="onClick">
      <span v-show="!showMobileCart">{{ totalInFrench }} €</span>
      <span v-show="showMobileCart" class="text-grey-dark">Fermer</span>
